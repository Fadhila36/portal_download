...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="https://ubpkarawang.ac.id" target="_blank">Universitas Buana Perjuangan Karawang</a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          ?>
          <li><a href="https://ubpkarawang.ac.id" target="_blank">Visit Us</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="container container-body">
    ...
    <hr>
    <center>copyright &copy; 2019 <a href="#" target="_blank">Universitas Buana Perjuangan Karawang</a></center>
  </div>
